              ...
              <div className="inner-content">
                ...
                <div className="inner-post mg-t-40">
                  ...
                  <div className="image-box">
                    <Image src={imgblogdetail1} alt="Axies" />
                    <Image src={imgblogdetail2} alt="Axies" />
                  </div>
                </div>
                ...
                <div className="sc-widget style-1">
                  ...
                  <div className="widget widget-social style-2">
                    ...
                    <ul>
                      <li>
                        <Link href="#" className="icon-fl-facebook"></Link>
                      </li>
                      <li className="style-2">
                        <Link href="#" className="icon-fl-coolicon"></Link>
                      </li>
                      <li className="mgr-none">
                        <Link href="#" className="icon-fl-mess"></Link>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="widget widget-tag style-1">
                ...
                <ul>
                  {dataTags.map((item, index) => (
                    <li key={index}>
                      <Link href="/blog" className="box-widget-tag">
                        {item.name}
                      </Link>
                    </li>
                  ))}
