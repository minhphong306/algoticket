import { algodClient } from "@/components/AlgorandWalletProviders";
...
export default function useWalletBalance() {
  ...
  const [walletAvailableBalance, setWalletAvailableBalance] = useState<
    string | null
  >(null);
  ...
  useEffect(() => {
    if (
      ...
      const balance = formatPrice(accountInfo.amount, false, {
