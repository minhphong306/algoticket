...
const SliderStyle1 = (props: SliderProps) => {
              ...
              <div className="wrap-heading flat-slider flex">
                <div className="content">
                  ...
                  <h1 className="heading mb-style">
                    <span className="">{props.title_2}</span>
                  </h1>
                  <h1 className="heading">
                    <span className="fill">{props.title_3}</span>
                    {props.title_4}
                  </h1>
                ...
                <div className="image">
                  <Image className="img-bg" src={props.imgbg} alt="axies" />
