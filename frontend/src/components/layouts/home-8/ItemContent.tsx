...
const ItemContent = () => {
  ...
  const gridBtn = useRef<HTMLElement>(null);
  const listContent = useRef<HTMLElement>(null);
  const gridContent = useRef<HTMLElement>(null);
          ...
          {dataPanel.map((data) => (
            <TabPanel key={data.id}>
              <div className="option">
                ...
                <div className="view">
                  <ul>
                    <li
                      onClick={listToggle}
                      ref={listBtn as React.LegacyRef<HTMLLIElement>}
                    ...
                    <li
                      onClick={gridToggle}
                      ref={gridBtn as React.LegacyRef<HTMLLIElement>}
              ...
              <div
                ...
                ref={listContent as React.LegacyRef<HTMLDivElement>}
              >
              ...
              <div
                ...
                ref={gridContent as React.RefObject<HTMLDivElement>}
              >
