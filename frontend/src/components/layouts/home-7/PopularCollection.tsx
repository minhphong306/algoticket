        ...
        <div className="row">
          <div className="col-box-12">
            <div className="heading-live-auctions">
              ...
              <Link href="/explore-03" className="exp style2 mg-t-23">
                EXPLORE MORE
              </Link>
            </div>
          </div>
            ...
            >
              <div className="sc-card-collection style-2 sc-card-style7">
                <div className="card-media-h7">
                  <Image src={item.imgTop} alt="Axies" />
                </div>
                <div className="card-media-h7 style2">
                  <Image src={item.imgBottom1} alt="Axies" />
                  <Image src={item.imgBottom2} alt="Axies" />
                  <Image src={item.imgBottom3} alt="Axies" />
                </div>
                <div className="card-bottom">
                  <div className="author">
                    <div className="content">
                      <h5>
                        <Link href="/authors-01">{item.title}</Link>
                      </h5>
                      <div className="infor">
