                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu style={{ margin: 0 }}>
                      ...
                      <Dropdown.Item href="#">
                        <div className="sort-filter">
                          <span>
                            <Image src={img3} alt="" /> Photography
                          </span>
                          <i className="fal fa-check"></i>
                        </div>
                      </Dropdown.Item>
                ...
                <div className="soft-right">
                  <Dropdown>
                    ...
                    <Dropdown.Menu style={{ margin: 0 }}>
                      <Dropdown.Item href="#">
                        <h6>Sort by</h6>
                        <Link className="sort-filter" href="#">
                          <span>Recently added</span>
                          <i className="fal fa-check"></i>
                        </Link>
                        <Link className="sort-filter active" href="#">
                          <span>Price: Low to High</span>
                          <i className="fal fa-check"></i>
                        </Link>
                        <Link className="sort-filter" href="#">
                  ...
                  <div className="meta-info">
                    <div className="author">
                      ...
                      <div className="info">
                        ...
                        <h6>
                          {" "}
                          <Link href="/authors-02">{item.nameAuthor}</Link>{" "}
                        </h6>
                      </div>
                    </div>
                    <div className="price">
